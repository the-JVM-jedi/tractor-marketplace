...
export default function SparePart() {
    ...
    // Spare part details (use actual data from your API or database here)
    const [formData, setFormData] = useState({
        title: "Chias Diesel Cap",
        price: "5.00",
        ...
        make: "Chias",
        model: "2023 Diesel Cap",
        location: "Nairobi",
        condition: "Used",
        year: "2022",
        stock: "In stock",
        partNumber: "CH-DC-2023",
        manufacturer: "Chias Industries",
    });
                ...
                <div className="pt-20">
                    <div className="flex items-center justify-center pt-30">
                        <div className="w-100 items-left">
                            <img src="../SparePartImage.jpg" alt="Spare Part Image" className="w-full h-60" />
                        </div>
                        ...
                        <div className="w-100 items-center">
                            <div className="flex flex-col">
                                ...
                                <div className="flex justify-items-end flex-col mt-4">
